...
Eftersom det turbaserade upplägget, som både Wordfeud och Quizkampen besitter, är ett väldigt väldesignat sådant så anammar även Chronos det upplägget. 

Det finns i övrigt många mobilspel som handlar om att två personer möts och mäter sina färdigheter inom ett visst område. Exempel på sådana applikationer är som tidigare nämnda Quizkampen och Wordfeud som båda toppar säljlistorna för Androidspel~\cite{appsalesrating}. 
Enligt säljstatistiken~\cite{appsalesrating} är detta koncept något som är attraktivt för många användare. Chronos kombinerar koncept från Quizkampen och Wordfeud i den mening att spelare på sätt och vis ska svara på frågor samt att lägga in saker på sin rätta plats. 
...
Eftersom sällskapsspelet \textit{När-då-då?}~\cite{nardada} och Chronos delar vissa konceptuella egenskaper så var förhoppningarna höga på att även vår applikation ska bli populär. En anledning som stärker dessa förhoppningar är att det för tillfället inte finns någon variant av detta spelkoncept till Android. Detta kan ge Chronos en större chans att lyckas bli populär på marknaden.
