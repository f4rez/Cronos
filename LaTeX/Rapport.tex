...
Denna vy ger fem olika möjligheter till interaktion. Högst upp i vyn finns det ett textfält för att fylla i sitt nya profilnamn och jämte finns en knapp (Spara) för att kolla med servern om namnet är ledigt och i så fall byta. Under knappen finns tre olika knappar som indikerar om en viss inställning är på, de tre inställningarna som kan göras med knapparna är i vilken ordning man vill sortera händelserna som ges i Pågående match(4). Det ges även möjlighet att stänga av notifikationer och att ställa in om det ska spelas ett ljud vid notifikation. I denna vyn finns även en hamburgarmeny ($\equiv$) för att visa Navigationsvyn (5).
\begin{figure}[H]
	\begin{center}
