...
\maketitle
\begin{abstract}
Vem vill inte kunna säga: ``Jag är bäst på...''? Människans natur gör att vi är tävlingsmänniskor, starkast överlever. Därför tror vi har spel som quizkampen och wordfued blivit så populära för man har möjlighet att se vem som är bäst på något. Vi vill skapa ett spel som läggs i denna kategorin, ett spel som går ut på att ordna historiska händelser relativt andra händelser. Spelet ska utvecklas till Android med en back-end som drar nytta av Google app-engines skalbarhet för att ge applikationen en möjlighet för att växa i takt med användarantalet. 
