...
Det intressanta med just de här applikationerna är upplägget. Wordfeud och Quizkampen är egnetligen ganska olika men den övergripande strukturen är densamma. Eftersom båda dessa appar har visat sig vara populära så antar vi att samma typ av övergripande struktur är ett upplägg som fungerar bra i mobilspelssammanhang. Qiezkampen och Wordfeud är som sagt turbaserade vilket innebär att medan ena spelaren gör sitt drag så väntar den andra spelaren. Det här upplägget skapar en förväntan hos den väntande spelaren eftersom den dels vill veta vem som gjort bäst ifrån sig, och också eftersom den vill göra sitt nästa drag. Förväntan är bra eftersom det höjer spelarens upplevelse av spelet. Varje gång spelaren tar upp sin telefon så \textit{hoppas} den att motspelaren har svarat. Det här innebär att spelaren accosierar en positiv händelse med spelet och risken att spelaren tröttnar minskar.
